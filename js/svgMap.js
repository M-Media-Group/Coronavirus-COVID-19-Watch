...
svgMap.prototype.createMap = function () {
  ...
  var mapAtrWrapper = this.createElement('div', 'svgMap-map-atr-wrapper', this.mapWrapper);
  var zoomContainer = this.createElement('div', 'svgMap-map-controls-zoom', mapControlsWrapper);
  var atrContainer = this.createElement('div', 'svgMap-map-attribute', mapAtrWrapper);
  atrContainer.innerHTML = '<small>'+this.options.attributionText+'</small>';
  ...
  Object.keys(mapPaths).forEach(function (countryID) {
    ...
    ['touchstart', 'mouseenter', 'touchdown'].forEach(function (event) {
      countryElement.addEventListener(event, function (e) {
...
svgMap.prototype.getTooltipContent = function (countryID) {
  ...
  if (!this.options.data.values[countryID]) {
    ...
    tooltipContentTable += '</table>';
    // tooltipContentTable += '<hr/><small>Data from <a href="https://mmediagroup.fr/covid-19" target="_BLANK" rel="noreferer">M Media</a> API</small>';
